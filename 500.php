<?php include 'includes/header.php'; ?>
    <div class="container">
      <div class="generic-page-container">
        <h2 style="color: #c00000; text-align: center; font-size: 2.5em; margin-bottom: 0.5em;">500 - Kesalahan Server Internal</h2>
        <p style="text-align: center; font-size: 1.1em; margin-bottom: 1.5em;">
            Maaf, terjadi masalah pada server kami sehingga tidak dapat memproses permintaan Anda.
            Tim kami sedang berupaya memperbaikinya. Silakan coba lagi nanti.
        </p>
